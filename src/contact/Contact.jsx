            ...
            <div className="contact-container">
                <div className="contact-text">
                    <p className="eiderwhite">
                        After a long journey from massaging backs to coding apps,
                        I'm excited to start applying my skills. Let's connect and
                        discuss how I can contribute to your team's success.
                    </p>
                </div>
                <div className="contact-info">
                    <p className="darkpink orbitron">Find me on</p>
                    <div class="social-card">
                        ...
                        <button class="social-btn gmail">
                            <span class="social-svgContainer">
                                <svg xmlns="http://www.w3.org/2000/svg" height="1.6em" viewBox="0 0 512 512" fill="white">
                                    <path d="M502.3 190.8L327.4 325.1l-31.5 23.8c-6.8 5.1-15.7 5.1-22.6 0l-31.5-23.8L9.7 190.8c-5.9-4.5-7-12.7-2.4-18.6 4.5-5.9 12.7-7 18.6-2.4L256 313.5 487.1 170c5.9-4.5 14.1-3.4 18.6 2.4 4.5 5.9 3.5 14.1-2.4 18.6z" />
                                    <path d="M464 64H48C21.5 64 0 85.5 0 112v288c0 26.5 21.5 48 48 48h416c26.5 0 48-21.5 48-48V112c0-26.5-21.5-48-48-48zM48 96h416c8.8 0 16 7.2 16 16v17.4L266.7 300.9c-9.1 6.8-22.2 6.8-31.3 0L32 129.4V112c0-8.8 7.2-16 16-16zm416 320H48c-8.8 0-16-7.2-16-16V168.6L234.6 327c9.2 6.9 21.7 6.9 30.8 0L464 168.6V400c0 8.8-7.2 16-16 16z" />
                                </svg>
                            </span>
                            <span class="social-BG"></span>
                        </button>
