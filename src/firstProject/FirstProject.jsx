...
const FirstProject = () => {
    ...
    const kicksSiteClick = () => {
        const kicksSiteUrl = 'https://sandorkicks.netlify.app/';
        window.open(kicksSiteUrl, '_blank');
    };
    return (
        <>
            <div className="first-project">
                ...
                <div className="kicks-description">
                    ...
                    <div className="description-card">
                        <div className="description-content">
                            <p className="description-para lightgray">
                                ...
                                It features product listings with search and filtering options, different guides,
                    ...
                    <div className="description-btn-container">
                        ...
                        <button className="Btn" onClick={kicksSiteClick}>
                            <span className="svgContainer">
